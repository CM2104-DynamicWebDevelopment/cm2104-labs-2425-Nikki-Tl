...
spotifyApi.clientCredentialsGrant().then( 
    function (data) {
        ...
        spotifyApi.setAccessToken(data.body['BQBl8MAmcxdVuZqTFMUxoxJYyN9Gtpiiz0Th1qYOY30EdfNryEtAvsXyljcag94LHfUESipOJqQCx0Bgo9lzddcKLpzQf4CFs6jZx9lQV4anQeDw02Zojq7oPvhCkolaoH-Db9AOOXk']); 
    },
    function (err) {
        console.log(
